...
trait HasDependenciesAndIndents
{
    ...
    public function availableFields(NovaRequest $request)
    {
        ...
        foreach ($fields as $field) {
            ...
            } else if ($field instanceof Indent) {
                $availableFields[] = $field;
                if ($field->child() instanceof NovaDependencyContainer) {
                    $this->extractChildFields([$field->child()]);
                }
            } else {
                $availableFields[] = $field;
            }
        ...
        foreach ($this->action()->fields() as $field) {
            if ($field instanceof NovaDependencyContainer) {
                ...
                if ($field->child() instanceof NovaDependencyContainer) {
                    ...
                    $this->childFieldsArr[] = $field->child();
                }
            } else {
                $availableFields[] = $field;
            }
