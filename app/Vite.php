...
use App\Exceptions\ViteException;
use App\Exceptions\ViteManifestNotFoundException;
use Closure;
...
class Vite implements Htmlable
{
    ...
    public function __invoke($entrypoints, $buildDirectory = null)
    {
        ...
        return (new Collection($entrypoints))
            ...
            ->unique('href')
            ->values()
            ->pipe(fn ($assets) => with(Js::from($assets), function($assets) use ($base) {
     ...
     * @return string
     *
     * @throws \App\Exceptions\ViteException
     */
    ...
    {
        return ($this->assetPathResolver ?? Closure::fromCallable('asset'))($path, $secure);
    }
     ...
     * @return array
     *
     * @throws \App\Exceptions\ViteManifestNotFoundException
     */
